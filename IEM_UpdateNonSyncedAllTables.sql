-- ========================================
-- IEM_UpdateNonSyncedAllTables
-- ========================================

DECLARE @prefix NVARCHAR(50) = N'C';  -- Database Name Prefix (e.g., A, B, C, D, S, U or empty for PROD)

-- NEW PARAMETER: Specific tables to process (comma-separated list)
-- Leave empty/NULL to process all tables, or specify like: 'table1,table2,table3'
DECLARE @SpecificTables NVARCHAR(500) = N'transfer_mst_all,trnitem_mst_all'; -- Example: ledger_mst_all,trnitem_all,journal_all
...
DECLARE @Truncate INT = 1; -- 0 = NO / 1 = YES
DECLARE @Repopulate INT = 1; -- 0 = NO / 1 = YES
    ...
    BEGIN
        ...
        BEGIN
            BEGIN TRY
                ...
                -- MODIFIED: Cursor now filters tables if specific tables are requested
